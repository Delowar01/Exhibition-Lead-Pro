...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 28, fontFamily: FONT.bold, letterSpacing: -0.5 },
  headingSub: { fontSize: 15, fontFamily: FONT.regular, marginTop: 6, opacity: 0.8 },
  disclaimer: { fontSize: 13, fontFamily: FONT.regular, fontStyle: "italic", marginBottom: 16, opacity: 0.7 },
  card: { borderWidth: 1, borderRadius: 16, padding: 16, marginBottom: 20, gap: 12, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 4, elevation: 2 },
  cardHead: { flexDirection: "row", alignItems: "center", gap: 8 },
  cardTitle: { fontSize: 18, fontFamily: FONT.bold },
  cardScope: { fontSize: 13, fontFamily: FONT.medium, opacity: 0.7 },
  loading: { fontSize: 14, fontFamily: FONT.regular, paddingVertical: 8, opacity: 0.7 },
  tileGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  tile: { flexGrow: 1, minWidth: "45%", borderWidth: 1, borderRadius: 12, padding: 16, shadowColor: "#000", shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 2, elevation: 1 },
  tileValue: { fontSize: 26, fontFamily: FONT.bold, letterSpacing: -0.5 },
  tileLabel: { fontSize: 11, fontFamily: FONT.bold, letterSpacing: 0.5, textTransform: "uppercase", marginTop: 6, opacity: 0.8 },
  actionsBox: { borderWidth: 1, borderRadius: 12, padding: 16, gap: 6 },
  actionsHead: { fontSize: 13, fontFamily: FONT.bold, marginBottom: 4, textTransform: "uppercase", letterSpacing: 0.5 },
  actionItem: { fontSize: 14, lineHeight: 22, fontFamily: FONT.regular },
  workloadBox: { gap: 8, marginTop: 8 },
