...
export const ListLeadsResponse = zod.object({
  ...
  "contactCompany": zod.string().nullish(),
  "stage": zod.string().describe('Pipeline stage key. Stages are tenant-configurable (custom keys allowed); the legacy default keys remain valid.'),
  "source": zod.string().nullish(),
...
export const CreateLeadBody = zod.object({
  "contactId": zod.number().nullish(),
  "stage": zod.string().default(createLeadBodyStageDefault).describe('Pipeline stage key. Stages are tenant-configurable (custom keys allowed); the legacy default keys remain valid.'),
  "source": zod.string().nullish(),
  "title": zod.string().nullish(),
  "value": zod.number().nullish(),
  "currency": zod.string().nullish(),
...
export const UpdateLeadBody = zod.object({
  "stage": zod.string().optional().describe('Pipeline stage key. Stages are tenant-configurable (custom keys allowed); the legacy default keys remain valid.'),
  "source": zod.string().nullish(),
  "title": zod.string().nullish(),
  "value": zod.number().nullish(),
  "currency": zod.string().nullish(),
...
export const DeleteWorkflowDefinitionBody = zod.object({
  "revision": zod.number().describe('The definition\'s current revision (stale values answer 409).')
})
