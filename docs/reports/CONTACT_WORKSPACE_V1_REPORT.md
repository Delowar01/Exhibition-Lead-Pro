...
- **End-to-end (Playwright):** desktop (1440×900), tablet (768×1024), and mobile (402×874) flows — login, all six tabs, AI suggested action round-trip, keep-mounted tab return — all passed.
